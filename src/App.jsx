import { CustomerReviews, Hero, PopularProducts, SuperQuality, Services, SpacialOffer, Subscribe, Footer} from './sections';
...
const App = () => (
  <main className="relative">
    ...
    <section className="bg-black padding-x padding-t pb-8 text-coral-red"><Footer /></section>
  </main>
);
